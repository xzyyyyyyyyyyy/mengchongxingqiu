        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
            ...
            <div className="bg-white rounded-lg p-3 sm:p-4">
              <h3 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">快速入口</h3>
              <div className="grid grid-cols-4 gap-2 sm:gap-4">
                <button
                  onClick={() => navigate('/bookmarks')}
                  className="flex flex-col items-center p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-pink-500 mb-1 sm:mb-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                  </svg>
                  <span className="text-xs sm:text-sm">我的收藏</span>
                </button>
                ...
                <button 
                  ...
                  className="flex flex-col items-center p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-500 mb-1 sm:mb-2" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                    <path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                  </svg>
                  <span className="text-xs sm:text-sm">我的作品</span>
                </button>
                ...
                <button
                  ...
                  className="flex flex-col items-center p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-orange-500 mb-1 sm:mb-2" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 3.5a1.5 1.5 0 013 0V4a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-.5a1.5 1.5 0 000 3h.5a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-.5a1.5 1.5 0 00-3 0v.5a1 1 0 01-1 1H6a1 1 0 01-1-1v-3a1 1 0 00-1-1h-.5a1.5 1.5 0 010-3H4a1 1 0 001-1V6a1 1 0 011-1h3a1 1 0 001-1v-.5z" />
                  </svg>
                  <span className="text-xs sm:text-sm">我的宠物</span>
                </button>
                ...
                <button 
                  ...
                  className="flex flex-col items-center p-2 sm:p-3 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-500 mb-1 sm:mb-2" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                  </svg>
                  <span className="text-xs sm:text-sm">浏览历史</span>
                </button>
              </div>
            </div>
            ...
            {/* Additional Features */}
            <div className="bg-white rounded-lg p-3 sm:p-4">
              <h3 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">宠物管理</h3>
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="text-left min-w-0">
                      <p className="font-medium text-sm sm:text-base">宠物证件夹</p>
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="text-left min-w-0">
                      <p className="font-medium text-sm sm:text-base">医疗记录</p>
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="text-left min-w-0">
                      <p className="font-medium text-sm sm:text-base">日历提醒</p>
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="text-left min-w-0">
                      <p className="font-medium text-sm sm:text-base">设置</p>
            ...
            <div className="bg-white rounded-lg p-3 sm:p-4">
              <div className="flex justify-between items-center mb-3 sm:mb-4">
                <h3 className="font-bold text-sm sm:text-base">我的好物</h3>
                <button 
